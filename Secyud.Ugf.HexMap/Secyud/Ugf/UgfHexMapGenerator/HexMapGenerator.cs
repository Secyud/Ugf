...
namespace Secyud.Ugf.UgfHexMapGenerator
{
    public class HexMapGenerator : MonoBehaviour
    {
        ...
        private void CreateLand()
        {
            ...
            if (landBudget > 0)
            {
                UgfLogger.LogWarning("Failed to use up " + landBudget + " land budget.");
                _landCells -= landBudget;
            }
        }
        ...
        private void ErodeLand()
        {
            ...
            ListPool<UgfCell>.Release(erodibleCells);
        }
        ...
        private UgfCell GetErosionTarget(UgfCell cell)
        {
            ...
            ListPool<UgfCell>.Release(candidates);
            return target;
        }
        ...
        private void CreateRivers()
        {
            ...
            if (riverBudget > 0)
            {
                UgfLogger.LogWarning("Failed to use up river budget.");
            }

            ListPool<UgfCell>.Release(riverOrigins);
        }
