...
{
    public class GuidFieldInSeries : FieldInSeries
    {
        ...
        protected override void BindValue(object value)
        {
            ...
            GuidInput.interactable = SeriesField.Field.ShowType == SShowType.Special;
        ...
        {
            var attr = SeriesField.Field.Info.GetCustomAttribute<TypeLimitAttribute>();
